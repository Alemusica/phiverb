...
TEST(stochastic, bad_reflections_box) {
    ...
    const util::aligned::vector<reflection> bad_reflections{
            reflection{cl_float3{{2.66277409, 0.0182733424, 6}}, 10, 1, 1, 0, 0, 0.0f, 0.0f},
            reflection{cl_float3{{3.34029818, 1.76905692, 6}}, 10, 1, 1, 0, 0, 0.0f, 0.0f},
            reflection{cl_float3{{4, 2.46449089, 1.54567611}}, 7, 1, 1, 0, 0, 0.0f, 0.0f},
    };
...
TEST(stochastic, bad_reflections_vault) {
    ...
    const util::aligned::vector<reflection> bad_reflections{
            reflection{cl_float3{{2.29054403, 1.00505638, -1.5}}, 2906, 1, 1, 0, 0, 0.0f, 0.0f},
