...
const auto badly_behaved_directions = util::aligned::vector<glm::vec3>{
        ...
        {0.473911583, -0.84311819, -0.25408566},
        {-0.156015098, -0.955536007, -0.250220358},
        {0.567212641, -0.7546525, 0.329802126},
...
const auto badly_behaved_rays = util::aligned::vector<geo::ray>{
        ...
        {glm::vec3{0.00000566244125, 3, 0.800823509},
         glm::vec3{-0.148433656, -0.987669587, 0.0497597083}},
        {glm::vec3{0, 0.000000596046448, 1.53889632},
